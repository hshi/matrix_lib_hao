...
namespace matrix_hao_lib
{
 ...
 void eigen_cpu_double_test()
 {
     ...
     if(flag==0) cout<<"PASSED! Eigen_cpu passed Real symmetric test!"<<endl;
     else cout<<"WARNING!!!!!!!!! Eigen_cpu failed symmetric test!"<<endl;
 ...
 void eigen_cpu_complexdouble_test()
 {
     ...
     flag+=diff(w,w_exact,1e-13);
     if(flag==0) cout<<"PASSED! Eigen_cpu passed Hermition test!"<<endl;
     else cout<<"WARNING!!!!!!!!! Eigen_cpu failed Hermintion test!"<<endl;
     //cout<<setprecision(16);
     //cout<<w<<endl;
     //cout<<w_exact<<endl;
     //cout<<a<<endl;
 ...
 void inverse_cpu_test()
 {
     Matrix<complex<double>,2> A={3,3,{ {1.0,0.0} ,   {3.0,4.0},    {2.123,3.11},
                                        {3.0,-2.0},   {2.0,0.0},    {5.123,3.11},
                                        {2.123,-5.11},{5.123,-6.11},{3,0.0} } };
     Matrix<complex<double>,2> INV_A;
     Matrix<complex<double>,2> INV_A_exact={3,3,{ {-0.31516333912326305,0.13336022037456957} , 
 ...
 void QRMatrix_cpu_test()
 {
     ...
     vector<double> detVec; double detVecM=QRMatrix_cpu(B,detVec);
